    ...
    <div class="menu_block">
      <nav>
        <ul class="sf-menu">
          ...
          <li><a href="Authentifier_Admin.jsp">Connectez-vous</a>
          <ul>
...
<form method="get">
  ...
  <center><h2><b>interface d'Authentification</b></h2></center>
    ...
    <input type="text" placeholder="Enter Code" name="login">

    <label><b>Password</b></label>
    <input type="password" placeholder="Enter Password" name="mdp">

    <button type="submit" formaction ="AuthentificationEtud">Connexion</button>
    <button type="submit" formaction ="enregistrement.jsp">S'enregistrer</button>
    <label>

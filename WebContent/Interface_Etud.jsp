    ...
    <div class="menu_block">
      <nav>
        <ul class="sf-menu">
          ...
          <li class="with_ul"><a href="ListOuvrageEtudiant">Chercher</a></li>
          <li><a href="ListOuvrageEtudiant">Filiere</a></li>
          <li><a href="ListOuvrageEtudiant">Ouvrages</a>
           <ul>
              <li><a href="ListOuvrageEtudiant">Lister</a></li>
              <li><a href="ListOuvrageEtudiant">Chercher</a></li>
            </ul>
          </li>
